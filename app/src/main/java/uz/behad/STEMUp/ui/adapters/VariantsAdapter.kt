package uz.behad.STEMUp.ui.adapters

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import uz.behad.STEMUp.R
import uz.behad.STEMUp.databinding.ItemQuizBinding

class VariantsAdapter : RecyclerView.Adapter<VariantsAdapter.ViewHolder>() {
    private val list = ArrayList<Pair<String, Boolean>>()
    private lateinit var listener: ((String) -> Unit)

    inner class ViewHolder(private val view: ItemQuizBinding) : RecyclerView.ViewHolder(view.root) {
        fun bind() {
